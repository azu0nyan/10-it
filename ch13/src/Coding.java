public class Coding {
    ...
    Map(
     ...
     2)Доработать вашу программу про кодирование, чтобы они читали данные для кодирования из тектового файла,
     и записывали код в бинарный. (см FileOps.helpfullyFunctions)
     ...
     4)Разобраться со случаями кода длинный не кратной 8(и лишними нулями)
     путем добавление в первые байты закодированного файла длинны кода.
